...
async function sendSpecificItems(limit = 20) {
    console.log('\n' + '='.repeat(60));
    ...
    try {
        ...
        // 4. Limite solicitado (Pegamos um pouco mais para garantir o sucesso após scraping)
        const targetItems = candidates.slice(0, Math.ceil(limit * 1.5));
